...
if ($nuevoNombre) { // Solo actualizar si el nuevo nombre no es null
    $DBmanager->UpdateCliente($_POST["Nombre"], $_POST["NombreNuevo"], $_POST["Email"],$_POST["Contrasenia"],$_POST["Cedula"],$nuevoNombre,$_POST["Telefono"],$_POST["NombreRealNombre"],$_POST["NombreRealPrimerApellido"],$_POST["NombreRealSegundoApellido"]);
} else {
